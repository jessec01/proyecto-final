...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', function (e) {
        ...
        const url = form.getAttribute('action') || "/yogui/api/register/";
        ...
        fetch(url, {
            ...
            .then(data => {
                ...
                succ.innerHTML = '<p>Usuario yogui creado exitosamente, redirigiendo a login...</p>';
                form.insertAdjacentElement('beforebegin', succ);
                setTimeout(() => {
                    window.location.href = form.getAttribute('data-success-url') || '/yogui/login/';
                }, 2000);
            })
            .catch(err => {
