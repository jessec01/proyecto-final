...
class Yogui(models.Model):
    ...
    id_card=models.CharField(max_length=8, unique=True)
    ...
    def __str__(self):
        return f'{self.user.fzirst_name} {self.user.last_name}'
    ...
    def update_level_suscribed(self, new_level):
        ...
        self.save()
    def update_is_suscribed(self):
        self.is_suscribed = not self.is_suscribed
        self.save()
